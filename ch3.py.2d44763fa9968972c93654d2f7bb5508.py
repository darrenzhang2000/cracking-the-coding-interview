...
One method is have an array sizes that keeps track of all of the stacks in the list. 
We would also have to keep track of the offset, maybe using a helper.
If index equals 5 and capacity equals 2, offset would be 2 * 5 = 10. So, the 6th stack (index 5) starts at element 
"""
